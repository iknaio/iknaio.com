---
title: "Services"
description: "Expert services from Iknaio: tailored analytics and reports, trainings and workshops for investigators, and crypto-estate forensics for heirs, executors, lawyers, notaries, and tax advisors."
...
services:
  - slug: "tailored-analytics"
    ...
    facts:
      ...
      - label: "What you get"
        text: "A written report with figures, tables, and methodology, or a reusable scripted analysis, with the underlying data exportable for the case file."
    actions:
      - text: "Contact us"
        url: "contact/"
        style: "primary"
  ...
  - slug: "trainings-workshops"
    ...
    facts:
      ...
      - label: "Format"
        text: "On-site or remote. Trainings on the platform, workshops on a topic, Train the Trainer on request."
    actions:
      - text: "Contact us"
        url: "contact/"
        style: "primary"
  ...
  - slug: "crypto-estate-forensics"
    ...
    facts:
      ...
      - label: "What you get"
        text: "A written report on identified wallets, probable custodial accounts, valuation at date of death and reporting date, evidence, and methodology. Assistance with asset transfer where keys are recovered. Expert testimony on request."
    actions:
      - text: "Contact us"
        url: "contact/"
        style: "primary"
...
cta:
  title: "Not sure which service fits?<br>Talk to us."
  actions:
    - text: "Contact us"
      url: "contact/"
      style: "primary"
