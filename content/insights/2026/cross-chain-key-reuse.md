...
tags: []
image: "images/insights/cross-chain-key-reuse/cover.png"
posttype: "insight"
aliases: ["/insights/cross-chain-kexy-reuse/", "/blog/cross-chain-kexy-reuse/", "/blog/cross-chain-key-reuse/"]
---
...
![Diagram showing one public key deriving multiple Bitcoin address types as well as Litecoin, Ethereum, and Tron addresses](/images/insights/cross-chain-key-reuse/figure-1.png)
...
![UpSet plot of reused public key counts across ETH, TRX, BTC, LTC, DOGE, and ZEC, led by 654,032 ETH-TRX keys](/images/insights/cross-chain-key-reuse/figure-2.png)
...
![Before/after diagram: shared public keys transfer a Bitcoin multi-input cluster to matching Ethereum addresses](/images/insights/cross-chain-key-reuse/figure-3.png)
...
![Pathfinder screenshot of a Bitcoin exchange address with cluster addresses related by public key on Ethereum and Tron](/images/insights/cross-chain-key-reuse/figure-4.png)
